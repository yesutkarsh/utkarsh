...
export default function page() {
    ...
    <>
        ...
        <div id="wrapper">
            ...
            <p id="about">"Welcome! I'm a seasoned web developer specializing in the MERN stack and Next.js framework. With a passion for crafting efficient, dynamic, and user-friendly web applications, I bring expertise in front-end and back-end development to the table.</p>

            <p id="about-mob">
                Expert MERN stack and Next.js developer here! Crafting dynamic and efficient web applications is my specialty. Let's bring your digital vision to life together!
            </p>
